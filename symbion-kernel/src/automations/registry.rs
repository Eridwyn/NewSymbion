        ...
        vec![
            ...
            TriggerSchema {
                ...
                fields: vec![
                    ...
                    FieldSchema {
                        name: "active_start_minute".to_string(),
                        label: "Minute début".to_string(),
                        field_type: FieldType::Number,
                        required: false,
                    ...
                    FieldSchema {
                        name: "active_end_minute".to_string(),
                        label: "Minute fin".to_string(),
                        field_type: FieldType::Number,
                        required: false,
                        default_value: Some(serde_json::json!(0)),
                        placeholder: None,
