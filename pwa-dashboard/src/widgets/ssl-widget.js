                ...
                ${this.domains.map(domain => html`
                  <div class="domain-card">
                    ...
                    <div class="domain-card-actions">
                      <button class="edit-btn" @click=${() => this.editDomain(domain)} title="Modifier" aria-label="Modifier le domaine">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                          <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/>
                        </svg>
                      </button>
                      <button class="delete-btn" @click=${() => this.deleteDomain(domain.id)} title="Supprimer" aria-label="Supprimer le domaine">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
